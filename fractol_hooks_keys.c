...
/*   Updated: 2024/05/12 00:40:54 by mman             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_process_other_keys(int keycode, t_mlxdata *mlxdata)
{
	if (keycode == 65307)
		...
		ft_zoom_out(mlxdata, 1.1);
	else if (keycode == 167 || keycode == 39 || keycode == 65451)
		ft_zoom_in(mlxdata, 1.0 / 1.1);
	else if (keycode == 61)
	{
